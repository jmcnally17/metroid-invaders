...
public:
  ...
  void moveMetroids(const std::array<std::array<IMetroid*, 11>, 5> &metroids, IClock &movementClock, std::unordered_map<std::string, int> &variables, const std::array<ISound*, 4> &sounds) const override;
